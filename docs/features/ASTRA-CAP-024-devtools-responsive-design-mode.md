# ASTRA-CAP-024 — Responsive Design Mode
...
> Canonical source: `HUMAN_APPROVED_ASTRA_62_CATALOG_2026-07-19` index 24

## Identity

| Field | Value |
|---|---|
| Stable ID | `ASTRA-CAP-024` |
...
Primary classification `EXPOSE_NATIVE` is taken exactly from the human-approved 62-item catalog (index 24). Supporting tags from the capability matrix are recorded as notes, not extra registry rows.
...
| canonical_index | 24 |
| canonical_title | Responsive Design Mode |
...
| notes | Canonical slice of matrix block B1 (DevTools RDM). |
...
Proposed Developer Hub launcher to native Responsive Design Mode.
