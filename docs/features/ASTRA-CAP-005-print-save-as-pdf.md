# ASTRA-CAP-005 — Print / Save as PDF workflows
...
> Canonical source: `HUMAN_APPROVED_ASTRA_62_CATALOG_2026-07-19` index 5

## Identity

| Field | Value |
|---|---|
| Stable ID | `ASTRA-CAP-005` |
| Slug | `print-save-as-pdf` |
| Title | Print / Save as PDF workflows |
...
Primary classification `EXPOSE_NATIVE` is taken exactly from the human-approved 62-item catalog (index 5). Supporting tags from the capability matrix are recorded as notes, not extra registry rows.
...
| canonical_index | 5 |
| canonical_title | Print / Save as PDF workflows |
...
| notes | Canonical slice of matrix block A1 (print/save-as-PDF). |

## Owners

| Role | Owner |
|---|---|
| Native owner | Firefox (printing) + Toolkit (pdf.js) |
| UX owner | Astra entrypoint over native print |
...
- `Firefox printing stack`

## Proposed Astra / Zen entrypoints

Proposed Print/Save-as-PDF discoverability entrypoint over native print.
