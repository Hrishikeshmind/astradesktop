# ASTRA-CAP-025 — Accessibility Inspector
...
> Canonical source: `HUMAN_APPROVED_ASTRA_62_CATALOG_2026-07-19` index 25

## Identity

| Field | Value |
|---|---|
| Stable ID | `ASTRA-CAP-025` |
| Slug | `devtools-accessibility-inspector` |
...
Primary classification `ASTRA_UX_WRAPPER` is taken exactly from the human-approved 62-item catalog (index 25). Supporting tags from the capability matrix are recorded as notes, not extra registry rows.
...
| canonical_index | 25 |
| canonical_title | Accessibility Inspector |
...
| notes | Canonical slice of matrix block B1 (DevTools a11y panel). |
...
| UX owner | Astra UX shell over native a11y inspector |
...
Proposed Developer Hub UX shell over native Accessibility Inspector.
