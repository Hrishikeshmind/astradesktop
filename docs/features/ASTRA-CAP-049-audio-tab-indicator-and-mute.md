# ASTRA-CAP-049 — Audio tab indicator and mute controls
...
> Canonical source: `HUMAN_APPROVED_ASTRA_62_CATALOG_2026-07-19` index 49

## Identity

| Field | Value |
|---|---|
| Stable ID | `ASTRA-CAP-049` |
| Slug | `audio-tab-indicator-and-mute` |
| Title | Audio tab indicator and mute controls |
...
Primary classification `USE_NATIVE` is taken exactly from the human-approved 62-item catalog (index 49). Supporting tags from the capability matrix are recorded as notes, not extra registry rows.

### Integration notes

- No distinct matrix block; mapped to F2 media; needs clarification.
...
| canonical_index | 49 |
| canonical_title | Audio tab indicator and mute controls |
...
| notes | No dedicated matrix block; associated with F2 media stack and tab UI. |

## Owners

| Role | Owner |
|---|---|
| Native owner | Gecko media + Firefox/Zen tab UI |
| UX owner | Native (Firefox/Zen) |
...
- `Gecko media + Firefox/Zen tab UI`
