# ASTRA-CAP-048 — Fullscreen, subtitles and captions
...
> Canonical source: `HUMAN_APPROVED_ASTRA_62_CATALOG_2026-07-19` index 48

## Identity

| Field | Value |
|---|---|
| Stable ID | `ASTRA-CAP-048` |
| Slug | `fullscreen-subtitles-captions` |
| Title | Fullscreen, subtitles and captions |
...
Primary classification `USE_NATIVE` is taken exactly from the human-approved 62-item catalog (index 48). Supporting tags from the capability matrix are recorded as notes, not extra registry rows.

### Integration notes

- Fullscreen warning is suppressed by pref; note for GOV.
...
| canonical_index | 48 |
| canonical_title | Fullscreen, subtitles and captions |
...
| notes | Canonical slice of matrix block F2 (fullscreen/captions). |

## Owners

| Role | Owner |
|---|---|
| Native owner | Gecko/DOM (fullscreen, WebVTT) |
