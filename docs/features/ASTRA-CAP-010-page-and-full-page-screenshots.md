# ASTRA-CAP-010 — Page and full-page screenshots
...
> Canonical source: `HUMAN_APPROVED_ASTRA_62_CATALOG_2026-07-19` index 10

## Identity

| Field | Value |
|---|---|
| Stable ID | `ASTRA-CAP-010` |
| Slug | `page-and-full-page-screenshots` |
| Title | Page and full-page screenshots |
| Canonical group | Student & Reading |
| Secondary groups | `Everyday Productivity` |
| Audiences | `STU`, `NORM`, `DEV` |
...
Primary classification `EXPOSE_NATIVE` is taken exactly from the human-approved 62-item catalog (index 10). Supporting tags from the capability matrix are recorded as notes, not extra registry rows.
...
| canonical_index | 10 |
| canonical_title | Page and full-page screenshots |
...
| notes | 1:1 with matrix block A4 (Screenshots). |

## Owners

| Role | Owner |
|---|---|
| Native owner | Firefox (browser/screenshots) |
| UX owner | Astra entrypoint over native Screenshots |
...
- `engine/browser/components/screenshots/`

## Proposed Astra / Zen entrypoints

Proposed Student Tools screenshots entrypoint over native Browser:Screenshot / Ctrl+Shift+S.
