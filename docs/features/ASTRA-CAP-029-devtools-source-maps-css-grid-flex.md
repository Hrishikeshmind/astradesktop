# ASTRA-CAP-029 — Source maps and CSS grid/flex tools
...
> Canonical source: `HUMAN_APPROVED_ASTRA_62_CATALOG_2026-07-19` index 29

## Identity

| Field | Value |
|---|---|
| Stable ID | `ASTRA-CAP-029` |
| Slug | `devtools-source-maps-css-grid-flex` |
| Title | Source maps and CSS grid/flex tools |
...
Primary classification `USE_NATIVE` is taken exactly from the human-approved 62-item catalog (index 29). Supporting tags from the capability matrix are recorded as notes, not extra registry rows.
...
| canonical_index | 29 |
| canonical_title | Source maps and CSS grid/flex tools |
...
| notes | Canonical slice of matrix block B1 (DevTools inspector tooling). |
...
| UX owner | Native (Firefox DevTools) |
