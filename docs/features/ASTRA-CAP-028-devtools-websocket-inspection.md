# ASTRA-CAP-028 — WebSocket inspection
...
> Canonical source: `HUMAN_APPROVED_ASTRA_62_CATALOG_2026-07-19` index 28

## Identity

| Field | Value |
|---|---|
| Stable ID | `ASTRA-CAP-028` |
| Slug | `devtools-websocket-inspection` |
...
Primary classification `USE_NATIVE` is taken exactly from the human-approved 62-item catalog (index 28). Supporting tags from the capability matrix are recorded as notes, not extra registry rows.
...
| canonical_index | 28 |
| canonical_title | WebSocket inspection |
...
| notes | Canonical slice of matrix block B1 (DevTools network/WS). |
