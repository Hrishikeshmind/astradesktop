# ASTRA-CAP-057 — Safe Browsing and download protection
...
> Canonical source: `HUMAN_APPROVED_ASTRA_62_CATALOG_2026-07-19` index 57

## Identity

| Field | Value |
|---|---|
| Stable ID | `ASTRA-CAP-057` |
| Slug | `safe-browsing-and-download-protection` |
| Title | Safe Browsing and download protection |
...
Primary classification `INTEGRATE` is taken exactly from the human-approved 62-item catalog (index 57). Supporting tags from the capability matrix are recorded as notes, not extra registry rows.

### Integration notes

- Safe Browsing native + Zen SMART Guard heuristics; surfaced by Suraksha.
...
| canonical_index | 57 |
| canonical_title | Safe Browsing and download protection |
...
| notes | Canonical slice of matrix block G1 (Safe Browsing) + A5 download protection. |

## Owners

| Role | Owner |
|---|---|
| Native owner | Firefox Safe Browsing (Google lists) |
| UX owner | Astra/Zen integration + Suraksha surface |
...
Suraksha Safe Browsing adapter + Zen SMART Guard heuristics over native SB.

### Related overlay / prefs paths (worktree presence only; not E2+)

- `src/zen/common/modules/AstraSurakshaSafeBrowsing.mjs (present)`
...
| state_refs | `ASTRA-STATE-002`, `ASTRA-STATE-013` |
