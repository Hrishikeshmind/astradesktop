# ASTRA-CAP-026 — Performance Profiler
...
> Canonical source: `HUMAN_APPROVED_ASTRA_62_CATALOG_2026-07-19` index 26

## Identity

| Field | Value |
|---|---|
| Stable ID | `ASTRA-CAP-026` |
| Slug | `devtools-performance-profiler` |
...
Primary classification `ASTRA_UX_WRAPPER` is taken exactly from the human-approved 62-item catalog (index 26). Supporting tags from the capability matrix are recorded as notes, not extra registry rows.
...
| canonical_index | 26 |
| canonical_title | Performance Profiler |
...
| notes | Canonical slice of matrix block B1 (DevTools performance). |
...
| UX owner | Astra UX shell over native profiler |
...
Proposed Developer Hub UX shell over native Performance Profiler.
