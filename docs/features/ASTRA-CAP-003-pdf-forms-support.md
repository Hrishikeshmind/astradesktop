# ASTRA-CAP-003 — PDF forms support
...
> Canonical source: `HUMAN_APPROVED_ASTRA_62_CATALOG_2026-07-19` index 3

## Identity

| Field | Value |
|---|---|
| Stable ID | `ASTRA-CAP-003` |
| Slug | `pdf-forms-support` |
| Title | PDF forms support |
...
Primary classification `USE_NATIVE` is taken exactly from the human-approved 62-item catalog (index 3). Supporting tags from the capability matrix are recorded as notes, not extra registry rows.
...
| canonical_index | 3 |
| canonical_title | PDF forms support |
...
| notes | Canonical slice of matrix block A1 (XFA/AcroForms). |
