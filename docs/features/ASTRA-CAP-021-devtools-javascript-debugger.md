# ASTRA-CAP-021 — JavaScript Debugger
...
> Canonical source: `HUMAN_APPROVED_ASTRA_62_CATALOG_2026-07-19` index 21

## Identity

| Field | Value |
|---|---|
| Stable ID | `ASTRA-CAP-021` |
| Slug | `devtools-javascript-debugger` |
...
Primary classification `EXPOSE_NATIVE` is taken exactly from the human-approved 62-item catalog (index 21). Supporting tags from the capability matrix are recorded as notes, not extra registry rows.
...
| canonical_index | 21 |
| canonical_title | JavaScript Debugger |
...
| notes | Canonical slice of matrix block B1 (DevTools debugger). |
...
Proposed Developer Hub launcher to native Debugger.
