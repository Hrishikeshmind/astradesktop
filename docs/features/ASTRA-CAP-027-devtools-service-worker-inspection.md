# ASTRA-CAP-027 — Service Worker inspection
...
> Canonical source: `HUMAN_APPROVED_ASTRA_62_CATALOG_2026-07-19` index 27

## Identity

| Field | Value |
|---|---|
| Stable ID | `ASTRA-CAP-027` |
| Slug | `devtools-service-worker-inspection` |
| Title | Service Worker inspection |
...
Primary classification `USE_NATIVE` is taken exactly from the human-approved 62-item catalog (index 27). Supporting tags from the capability matrix are recorded as notes, not extra registry rows.
...
| canonical_index | 27 |
| canonical_title | Service Worker inspection |
...
| notes | Canonical slice of matrix block B1 (DevTools application/SW). |
