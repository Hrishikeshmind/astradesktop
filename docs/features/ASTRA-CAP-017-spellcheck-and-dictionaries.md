# ASTRA-CAP-017 — Spellcheck and dictionaries
...
> Canonical source: `HUMAN_APPROVED_ASTRA_62_CATALOG_2026-07-19` index 17

## Identity

| Field | Value |
|---|---|
| Stable ID | `ASTRA-CAP-017` |
| Slug | `spellcheck-and-dictionaries` |
| Title | Spellcheck and dictionaries |
| Canonical group | Language & Access |
| Secondary groups | `India & Language` |
...
Primary classification `ENABLE_AFTER_TEST` is taken exactly from the human-approved 62-item catalog (index 17). Supporting tags from the capability matrix are recorded as notes, not extra registry rows.

### Integration notes

- Verify Indian-language Hunspell dictionaries are actually packaged.
...
| canonical_index | 17 |
| canonical_title | Spellcheck and dictionaries |
...
| notes | 1:1 with matrix block A11 (Spellcheck/dictionaries). |

## Owners

| Role | Owner |
|---|---|
| Native owner | Firefox Toolkit (Hunspell) |
...
None required (NATIVE_ONLY). Packaging verification of Indian-language dictionaries is a Batch 0/5 gate.
